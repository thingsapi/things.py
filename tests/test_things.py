...
import unittest
from things.things import Things
...
class ThingsCase(unittest.TestCase):
    ...
    def setUp(self):
        self.things = Things(database='tests/demo.sqlite3')
        self.things.tag_mit = 'MIT'

    def test_today(self):
        """Test Today."""
        tasks = self.things.get_today()
    ...
    def test_upcoming(self):
        """Test Upcoming."""
        tasks = self.things.get_upcoming()
    ...
    def test_next(self):
        """Test Next."""
        tasks = self.things.get_anytime()
        self.assertEqual(29, len(tasks))

    # def test_backlog(self):
    #     """Test Backlog."""
    #     tasks = self.things.get_someday()
    #     self.assertEqual(1, len(tasks))

    def test_waiting(self):
        """Test Waiting."""
        tasks = self.things.get_waiting()
        self.assertEqual(3, len(tasks))

    def test_mit(self):
        """Test MIT."""
        tasks = self.things.get_mit()
        self.assertEqual(6, len(tasks))

    def test_completed(self):
        """Test completed tasks."""
        tasks = self.things.get_completed()
        self.assertEqual(3, len(tasks))

    def test_cancelled(self):
        """Test cancelled tasks."""
        tasks = self.things.get_cancelled()
        self.assertEqual(2, len(tasks))

    def test_trashed(self):
        """Test trashed tasks."""
        tasks = self.things.get_trashed()
        self.assertEqual(10, len(tasks))

    def test_all(self):
        """Test all tasks."""
        tasks = self.things.get_all()
        self.assertEqual(56, len(tasks))

    def test_due(self):
        """Test due tasks."""
        tasks = self.things.get_due()
        self.assertEqual(1, len(tasks))

    def test_lint(self):
        """Test tasks that should be cleaned up."""
        tasks = self.things.get_lint()
        self.assertEqual(4, len(tasks))

    def test_empty_projects(self):
        """Test projects that are emptÿ."""
        tasks = self.things.get_empty_projects()
        self.assertEqual(2, len(tasks))

    def test_cleanup(self):
        """Test tasks that should be cleaned up."""
        tasks = self.things.get_cleanup()
    ...
    def test_get_minutes_today(self):
        ...
        minutes = self.things.get_minutes_today()
