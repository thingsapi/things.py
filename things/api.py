...
def tasks(uuid=None, include_items=False, **kwargs):  # noqa: C901
    ...
    last : str, default None, optional
        Limit returned tasks to tasks created in the last X days or weeks. Takes as input string of format 'X[d/w]' where X is a non-negative integer and 'd' stands for days and 'w' for weeks.
